...
export default {
  ...
  data: () => ({
    ...
    services: [
      {
        title: process.env.SERVICES_TITLE_1 || 'Dating & Relationshio',
        description:
      ...
      {
        title: process.env.SERVICES_TITLE_2 || 'Grief & Loss Consueling',
        description:
      ...
      {
        title: process.env.SERVICES_TITLE_3 || 'Self Esteem Therapy',
        description:
